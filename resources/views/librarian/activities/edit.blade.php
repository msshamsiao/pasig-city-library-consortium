...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-600">Update activity details</p>
        </div>

        <!-- Rejection Notice -->
        @if($activity->rejection_reason)
        <div class="mb-6 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg">
            <p class="font-medium">This activity was rejected:</p>
            <p class="text-sm mt-1">{{ $activity->rejection_reason }}</p>
        </div>
        @endif

        <!-- Form -->
        <div class="bg-white shadow-sm rounded-lg p-6">
            <form action="{{ route('librarian.activities.update', $activity->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="time" name="time_start" id="time_start" value="{{ old('time_start', $activity->time_start) }}"
                    ...
                    <div>
                        ...
                        <input type="time" name="time_end" id="time_end" value="{{ old('time_end', $activity->time_end) }}"
